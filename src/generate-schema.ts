// I literally can't find any better way to get this to consistently work than to just copy and paste all the types into this file.
...
// Function to generate and print JSON schema
function generateSchema(): JSONSchemaObject {
  const settings: TJS.PartialArgs = {
    required: true,
  };
  const program = TJS.getProgramFromFiles(["generate-schema.ts"]);
